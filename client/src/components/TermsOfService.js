  ...
  return (
    <div>
      <Container>
        ...
        <p>
          julie-travel-planner is using the Google Maps API(s) and follows the
          ...
          , you are agreeing to be bound by these terms of service, as well as
          Google Maps
          {" "}
        ...
        <ol type="a">
          <li>
            ...
            materials (information or software) on julie-travel-planner's
            ...
            <ol type="i">
              ...
              <li>
                ...
                on julie-travel-planner's website;
              </li>
              <li>
          ...
          <li>
            ...
            these restrictions and may be terminated by julie-travel-planner at
        ...
        <ol type="a">
          <li>
            The materials on julie-travel-planner's website are provided on an
            'as is' basis. julie-travel-planner makes no warranties, expressed
          ...
          <li>
            Further, julie-travel-planner does not warrant or make any
        ...
        <p>
          In no event shall julie-travel-planner or its suppliers be liable for
          ...
          inability to use the materials on julie-travel-planner's website, even
          if julie-travel-planner or a julie-travel-planner authorized
        ...
        <p>
          The materials appearing on julie-travel-planner's website could
          include technical, typographical, or photographic errors.
          julie-travel-planner does not warrant that any of the materials on its
          website are accurate, complete or current. julie-travel-planner may
          make changes to the materials contained on its website at any time
          without notice. However julie-travel-planner does not make any
        ...
        <p>
          julie-travel-planner has not reviewed all of the sites linked to its
          website and is not responsible for the contents of any such linked
          site. The inclusion of any link does not imply endorsement by
          julie-travel-planner of the site. Use of any such linked website is at
          the user's own risk.
        </p>
        ...
        <p>
          julie-travel-planner may revise these terms of service for its website
        ...
        <p>
          ...
          with the laws of Maine and you irrevocably submit to the exclusive
        ...
        <p>
          ...
          information is protected and maintained. julie-travel-planner may
          change this privacy policy from time to time at julie-travel-planner's
          sole discretion.
        </p>
      </Container>
    </div>
